      ...
      <section className="departmentHolder">
        ...
        <div className="department">
          ...
          <div className="left">
            ...
            <p>
              We offer a full service deli that serves hot and cold entrees for
              any occasion as well as soups, salads, and sandwiches. Our
              ...
              prices than most grocery or cheese specialty stores. We have
              Domestic, imported, hand made, raw, goat, sheep, cow, or water
              buffalo cheese--We've got just about any cheese you could ever
              want.
            </p>
          </div>
        </div>
        <div className="department">
          <div className="left">
            ...
            <p>
              ...
              large selection of meat items. We will be happy to custom cut meat
        ...
        <div className="department">
          ...
          <p>
            ...
            orders are welcome for birthdays or special occasions. Just call in
            24 hours ahead for your special cake orders.
          </p>
          </div>       
          <div className="departmentPic">
