...
function About() {
  return (
    <section className="aboutHolder">
      ...
      <p className="aboutInfo">
        <h3 className="aboutTitle">1939</h3>John Lorenzo opens the California Market on First Street in
        Winters. It was Winters' first modern supermarket complete with fresh
        meat, fish, and vegetables all under one roof.
      </p>
      <p className="aboutInfo">
        <h3 className="aboutTitle">1964</h3>Al Lorenzo (John's son), opens the New California Market at
        111 Main Street. It is 3 times larger than the old store and features
        state of the art refrigeration units.
      </p>
      <p className="aboutInfo">
        <h3 className="aboutTitle">1989</h3>In March of 1989 Al and his sons--John, Jeff, and David
      ...
      <p className="aboutInfo">
        <h3 className="aboutTitle">2004</h3>In 2004 the Lorenzo brothers complete a major remodel with
